...
parser.add_argument('--img_output_dir', type=str, default="/mnt/zhaosheng/4dct/output",help='')
...
patients = sorted([ddf.split("_")[1] for ddf in os.listdir(ddf_dir) if ".npy" in ddf and "49" in ddf and "_9_0" in ddf])
