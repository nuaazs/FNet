...
class CBAMUNet(nn.Module):
    ...
    def __init__(
        ...
        def _create_block(
            ...
            return nn.Sequential(down,cbam, SkipConnection(subblock), up)
...
if __name__ == "__main__":
    cbamunet = CBAMUNet(spatial_dims=3, in_channels=1, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), kernel_size=3, up_kernel_size=3, num_res_units=0, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
