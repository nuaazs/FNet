...
class FNet(nn.Module):
    def __init__(self):
        ...
        self.u03 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u04 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u05 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u06 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u07 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u08 = CBAMUNet(spatial_dims=3, in_channels=2, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
        self.u09 = CBAMUNet(spatial_dims=3, in_channels=1, out_channels=3, channels=(32, 64, 128, 256, 32), strides=(2,2,2,2), num_res_units=2, kernel_size=3, up_kernel_size=3, act='PRELU', norm='INSTANCE', dropout=0.0, bias=True, dimensions=None)
    ...
    def forward(self,input_images):
        ...
        ddf3 = self.u03(torch.cat([t0,image2],1))+ ddf2
        image3 = self.warp_layer(t0, ddf3)
        ddf4 = self.u04(torch.cat([t0,image3],1)) + ddf3
        ...
        ddf7 = self.u07(torch.cat([t0,image8],1))+ ddf8
        image7 = self.warp_layer(t0, ddf7)
        ddf6 = self.u06(torch.cat([t0,image7],1)) + ddf7
        image6 = self.warp_layer(t0, ddf6)

        ddf5_1 = self.u05(torch.cat([t0,image4],1)) + ddf4
        ddf5_2 = self.u05(torch.cat([t0,image6],1)) + ddf6
        ddf5 = (ddf5_1+ddf5_2)/2
        image5 = self.warp_layer(t0, ddf5)

        return ddf1,ddf2,ddf3,ddf4,ddf5,ddf6,ddf7,ddf8,ddf9,image1,image2,image3,image4,image5,image6,image7,image8,image9
